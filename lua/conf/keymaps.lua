...
function M.Config()
	...
	local mappings = {
		...
		{ mode = "n", key = "<leader>flg", map = ":lua _Git()<CR>", enabled = true },
		{ mode = "n", key = "<leader>flu", map = ":lua _Lua()<CR>", enabled = true },
		{ mode = "n", key = "<leader>fnd", map = ":lua _Node()<CR>", enabled = true },
		{ mode = "n", key = "<leader>fpy", map = ":lua _Python()<CR>", enabled = true },
